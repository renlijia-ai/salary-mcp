                ...
                items: {
                  ...
                  properties: {
                    ...
                    bizLabel: {
                      type: "string",
                      description:
                        "字段类型； hrmregister 从智能人事花名册获取 , base_pay 从薪资档案获取 , basic_text 算薪所需要的员工信息通过薪资档案进行维护 , data_center 数据中心",
                      enum: [
                        "floating_data",
                        "hrmregister",
                        "base_pay",
                    ...
                    bizSource: {
                      type: "string",
                      description:
                        "字段来源 数据来源 来源如果是考勤等外部数据需要使用getTemSalaryItem 的 bizSource",
                    },
                    bizSourceName: {
                      type: "string",
    ...
    inputSchema: getInputSchema(
      {
        ...
        must: {
          type: "boolean",
          description:
            "是否必填 该属性前端页面不展示但数据库里需要存, 供定调薪审批设置使用",
        },
        placeholder: {
          type: "string",
          description:
            "占位提示（仅输入类组件）该属性前端页面不展示但数据库里需要存, 供定调薪审批设置使用 ",
        },
        required: {
          type: "boolean",
          description:
        ...
        selected: {
          type: "boolean",
          description:
            "在定调审批模版内是否被选中 该属性前端页面不展示但数据库里需要存, 供定调薪审批设置使用",
        },
        type: {
          type: "string",
        ...
        salarySettingItemVO: {
          ...
          formula: {
            ...
            fractionalMode: {
              type: "string",
              description:
                "小数模式. round 四舍五入, floor 向下取整  ,ceil 向上取整",
